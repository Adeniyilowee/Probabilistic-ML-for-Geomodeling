...
def interactive_plotting(all_data, degree, a, b):
    ...
    pl.add_mesh(model_subdivided_mesh_1, color='darkgray', use_transparency=False, show_edges=False, pickable=False, name='subdivided_surface2')  # , scalars=model_subdivided_mesh[:].points[:, 2]
    pl.add_mesh(model_subdivided_mesh_2, color='sienna', use_transparency=False, show_edges=False, pickable=False, name='subdivided_surface3')  # , scalars=model_subdivided_mesh[:].points[:, 2]
