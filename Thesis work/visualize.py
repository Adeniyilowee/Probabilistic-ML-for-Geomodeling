...
def interactive_plotting(all_data, degree, a, b):
    ...
    def update_control_cage(point, idx):
        ...
        dat, points = all_data.subsurfmodel(a, b, all_data.data['ctr_points_plot'][0], all_data.data['dimension'][0], all_data.data['knots_list_u'][0], all_data.data['knots_list_v'][0])
